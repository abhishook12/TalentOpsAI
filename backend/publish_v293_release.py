...
try:
    ...
    if existing:
        ...
        existing.release_notes = 'TalentOps Scout v2.9.3 with Extractor v4.6.2. Resolves company extraction noise and enforces semantic entity discrimination.'
        ...
        new_rel = ScoutRelease(
            ...
            release_notes='TalentOps Scout v2.9.3 with Extractor v4.6.2. Resolves company extraction noise and enforces semantic entity discrimination.',
    ...
    print(f'Active Canonical Release: ID {active.id}, Version: {active.version}, SHA: {active.sha256[:16]}..., Size: {active.size_bytes}')
finally:
    db.close()
