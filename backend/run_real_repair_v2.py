...
for rec in target_pool:
    ...
    if is_plan_a:
        ...
        # Reconstruct potential email string
        ...
        # Check duplicate by exact email match OR exact name match at company
        best_dup = None
        ...
        if best_dup:
            ...
            if is_personal:
                ...
                if gen_email:
                    rec.email = gen_email
                    email_to_rec[gen_email_lower] = rec # Register newly assigned email to avoid self-collisions within batch!
