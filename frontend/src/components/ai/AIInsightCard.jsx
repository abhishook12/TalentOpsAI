...
export default function AIInsightCard({
  ...
  return (
    ...
    >
      ...
      {/* Main Claim */}
      <div style={{ fontSize: '13px', fontWeight: 600, lineHeight: 1.5, color: 'var(--text-primary, #f8fafc)' }}>
        {claim}
      </div>
      ...
      {/* Action footer */}
      {onExplain && (
        <div style={{ display: 'flex', justifyContent: 'flex-end', borderTop: '1px solid var(--border, #1e293b)', paddingTop: '8px' }}>
          <button
            onClick={onExplain}
            style={{
              display: 'flex',
