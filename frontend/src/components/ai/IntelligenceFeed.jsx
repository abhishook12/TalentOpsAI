...
export default function IntelligenceFeed({ onTriggerAction }) {
  const DEFAULT_FEED = [
    ...
    },
    {
      id: 'sig_2',
      icon: '🚀',
      title: 'Engineering Leadership Transition: Principal Engineer',
      description: 'Candidate Elena Rostova transitioned to Director of AI Platform with verified engineering credentials.',
      summary: 'Candidate Elena Rostova transitioned to Director of AI Platform with verified engineering credentials.',
      evidence_type: 'VERIFIED',
      provenance: 'VERIFIED',
      priority: 'important',
      confidence: 0.92,
      source: 'Talent Profile Activity',
      timestamp: '4h ago',
      created_at: new Date().toISOString(),
