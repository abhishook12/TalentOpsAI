              ...
              {activeTab === 'general' && (
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    <input value={settings.general_platformName} onChange={e => handleChange('general_platformName', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', outline: 'none' }} />
                  </div>

                  <div style={{ display: 'flex', gap: 16 }}>
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
                      <label style={{ fontSize: 13, color: 'var(--text-muted)' }}>Timezone</label>
                      <select value={settings.general_timezone} onChange={e => handleChange('general_timezone', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', outline: 'none' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      <select value={settings.general_language} onChange={e => handleChange('general_language', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', outline: 'none' }}>
              ...
              {activeTab === 'auth' && (
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 16 }}>
                    ...
                    <input type="number" value={settings.auth_sessionTimeout} onChange={e => handleChange('auth_sessionTimeout', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', width: 200, outline: 'none' }} />
                  </div>
                </>
              )}
              ...
              {activeTab === 'security' && (
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    <input type="number" value={settings.sec_rateLimits} onChange={e => handleChange('sec_rateLimits', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', width: 200, outline: 'none' }} />
                  </div>

                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 16 }}>
                    <label style={{ fontSize: 13, color: 'var(--text-muted)' }}>IP Whitelist (Comma separated)</label>
                    <textarea value={settings.sec_ipWhitelist} onChange={e => handleChange('sec_ipWhitelist', e.target.value)} rows={4} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', resize: 'vertical', outline: 'none' }} placeholder="e.g. 192.168.1.1, 10.0.0.0/24" />
                  </div>
                </>
              )}
              ...
              {activeTab === 'system' && (
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    <input type="number" value={settings.sys_dataRetentionDays} onChange={e => handleChange('sys_dataRetentionDays', e.target.value)} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', width: 200, outline: 'none' }} />
                  </div>
